...
const AdjacencyMatrix_1 = __importDefault(require("./class/AdjacencyMatrix"));
const AdjacencyList_1 = __importDefault(require("./class/AdjacencyList"));
const WeightedAdjacencyMatrix_1 = __importDefault(require("./class/WeightedAdjacencyMatrix"));
const WeightedAdjacencyList_1 = __importDefault(require("./class/WeightedAdjacencyList"));
console.log('----------------------------------------------');
console.log('ADJACENCY MATRIX GRAPH:');
console.log('----------------------------------------------\n');
const adjacencyMatrixGraph = new AdjacencyMatrix_1.default(8, false);
...
console.log('----------------------------------------------\n');
const adjacencyListGraph = new AdjacencyList_1.default();
...
console.log('----------------------------------------------\n');
const weightedAdjacencyMatrixGraph = new WeightedAdjacencyMatrix_1.default(8, true);
...
console.log('WEIGHTED ADJACENCY MATRIX GRAPH:');
console.log('----------------------------------------------\n');
const weightedAdjacencyListGraph = new WeightedAdjacencyList_1.default();
